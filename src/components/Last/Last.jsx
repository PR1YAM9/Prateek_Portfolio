  ...
  const list = [
    {
      ...
      fourth:
        "Responsible for recruiting, training core members, and overseeing projects, finances, and events.",
    },
    {
      id: 2,
      ...
      third: "June 2023 - Present",
      fourth:
        "Facilitating various companies with internship and placement drive.",
    },
  ];
